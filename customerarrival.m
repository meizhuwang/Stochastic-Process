...
title(’pmf of number of arrivals for a Poisson Process of \lambda=1,and for T=10’,’Fontsize’,12)
...
xlabel(’t’,’Fontsize’,12)
ylabel(’pmf’,’Fontsize’,12)
title(’pmf of number of arrivals for a Poisson Process of \lambda=1,and for T=5’,’Fontsize’,12)
legend(’Estimated’,’Calculated’,’Location’,’Best’)
...
% Generate arrivals for all times and experiments
arrival = binornd(1,p,n,nr_experiments);
% Compute time of first arrival : Method 1
...
% Compute time of first arrival : Method 2
time=0;
experiment=1;
...
legend(’Estimated’,’Calculated’,’Location’,’Best’)%Compare with exponential cdf
figure
